...
* The original package name 'io.mubel.server.mubel-server' is invalid and this project uses '
  io.mubel.server.mubelserver' instead.
...
```
$ docker run --rm mubel-server:0.0.1-SNAPSHOT
```
